...
%define stablelibre -%{ktarvers}%{?stablegnux}
...
* Sat Jan 29 2022 Justin M. Forbes <jforbes@fedoraproject.org> [5.16.4-0]
- Revert "drm/i915: Flush TLBs before releasing backing store" (Justin M. Forbes)
