/*
 * $Id: FontFactoryImp.java,v 1.9 2007/01/19 14:16:58 blowagie Exp $
 * $Name:  $
 *
 ...
 */
    ...
    public Font getFont(Properties attributes) {
        ...
        Color color = null;
        String value = (String) attributes.remove(Markup.HTML_ATTR_STYLE);
        ...
        if ((value = (String)attributes.remove(Markup.HTML_ATTR_STYLE)) != null) {
            style |= Font.getStyleValue(value);
        }
