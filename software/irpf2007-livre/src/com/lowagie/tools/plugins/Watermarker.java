/*
 * $Id: Watermarker.java,v 1.9 2007/02/12 11:30:10 blowagie Exp $
 * $Name:  $
 *
...
public class Watermarker
  ...
  static {
    addVersion("$Id: Watermarker.java,v 1.9 2007/02/12 11:30:10 blowagie Exp $");
  }
  ...
  public Watermarker() {
    ...
    arguments.add(new FileArgument(this, "srcfile",
                                   ...
                                   new PdfFilter()));
    arguments.add(new ToolArgument(this, "watermark",
                                   "The text that can be used as watermark",
                                   String.class.getName()));
    arguments.add(new ToolArgument(this, "fontsize",
                                   "The fontsize of the watermark text",
                                   String.class.getName()));
    arguments.add(new ToolArgument(this, "opacity",
