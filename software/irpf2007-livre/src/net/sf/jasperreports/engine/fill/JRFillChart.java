 ...
 * @version $Id: JRFillChart.java 1400 2006-09-21 10:45:46 +0300 (Thu, 21 Sep 2006) lucianc $
 */
public class JRFillChart extends JRFillElement implements JRChart
{
	...
	private void configureChart(JFreeChart chart, JRChartPlot jrPlot, byte evaluation) throws JRException
	{
		...
		if (getLegendColor() != null)
			chart.getLegend().setItemPaint(getLegendColor());
	 ...
	 */
	private void configureAxis(Axis axis, JRFont labelFont, Color labelColor,
								 JRFont tickLabelFont, Color tickLabelColor, String tickLabelMask,
								 Color lineColor)
	{
		if (labelFont != null)
		{
