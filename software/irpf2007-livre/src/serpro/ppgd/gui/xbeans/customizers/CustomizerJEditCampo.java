/* CustomizerJEditCampo - Decompiled by JODE
...
public class CustomizerJEditCampo extends JPanel implements Customizer
{
  ...
  private class NavegadorAtributos extends JPanel implements ListSelectionListener
  {
    ...
    private CustomizerJEditCampo customizer;
    
    public NavegadorAtributos (JEditCampo aBean, CustomizerJEditCampo aCustomizer)
    {
      bean = aBean;
