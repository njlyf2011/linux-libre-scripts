/* PainelMovimentacaoRebanhoBrasil - Decompiled by JODE
...
public class PainelMovimentacaoRebanhoBrasil extends JPanel implements PainelIRPFIf
{
  private JScrollPane jScrollPane1;
  private TableMovimentacoesRebanhoBrasil tableMovimentacoesRebanhoBrasil1;
  
  public PainelMovimentacaoRebanhoBrasil ()
  {
    PlataformaPPGD.getPlataforma ().setHelpID (this, "ARRebanho");
    initComponents ();
    tableMovimentacoesRebanhoBrasil1.setObjetoNegocio (IRPFFacade.getInstancia ().getAtividadeRural ().getBrasil ().getMovimentacaoRebanho ());
  }
  ...
  {
    return "Movimenta\u00e7\u00f5es do Rebanho - Brasil";
  }
