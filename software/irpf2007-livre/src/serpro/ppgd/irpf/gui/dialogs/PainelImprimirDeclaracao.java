/* PainelImprimirDeclaracao - Decompiled by JODE
...
public class PainelImprimirDeclaracao extends JPanel
{
  ...
  public PainelImprimirDeclaracao ()
  {
    initComponents ();
	...
	if (e.getClickCount () == 2 && edtTableDecs.getSelectedRowCount () > 0)
	  PainelImprimirDeclaracao.this.btnOkActionPerformed (null);
      }
    });
  ...
  private void initComponents ()
  {
    ...
    btnOk.addActionListener (new ActionListener ()
    {
      ...
      {
	PainelImprimirDeclaracao.this.btnOkActionPerformed (evt);
      }
    });
    ...
    btnCancelar.addActionListener (new ActionListener ()
    {
      public void actionPerformed (ActionEvent evt)
      {
	PainelImprimirDeclaracao.this.btnCancelarActionPerformed (evt);
      }
    });
  ...
  private void btnOkActionPerformed (ActionEvent evt)
  {
	...
	if (rows.length > 1)
	  ...
	  {
	    final IdentificadorDeclaracao id = edtTableDecs.getIdentificadorDeclaracao (edtTableDecs.getSelectedRow ());
	    ProcessoSwing.executa (new Tarefa ()
	    {
	      public Object run ()
	      {
		IRPFGuiUtil.exibeDialog (new PainelSelecaoTipoImpressao (id), true, "IRPF " + ConstantesGlobais.EXERCICIO + " Impress\u00e3o", false);
		return null;
	      }
	    });
	  }
