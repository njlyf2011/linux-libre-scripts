/* PainelGCapMERendReais - Decompiled by JODE
...
public class PainelGCapMERendReais extends JPanel implements PainelIRPFIf
{
  ...
  private TableGCapMERendReais tableGCapMERendReais1;
  ...
  private void initComponents ()
  {
    ...
    tableGCapMERendReais1 = new TableGCapMERendReais ();
    ...
    jScrollPane1.setViewportView (tableGCapMERendReais1);
    GroupLayout layout = new GroupLayout (this);
    setLayout (layout);
    layout.setHorizontalGroup (layout.createParallelGroup (1).add (2, layout.createSequentialGroup ().addContainerGap ().add (layout.createParallelGroup (2).add (1, jScrollPane1, -1, 544, 32767).add (1, jPanel1, -1, -1, 32767)).addContainerGap ()));
    layout.setVerticalGroup (layout.createParallelGroup (1).add (2, layout.createSequentialGroup ().addContainerGap ().add (jScrollPane1, -1, 360, 32767).addPreferredGap (0).add (jPanel1, -2, -1, -2)));
  }
