...
* Tue Jan 19 2010 Chuck Ebbert <cebbert@redhat.com>  2.6.30.10-105.2.3
- CVE-2010-0007: kernel: normal users can modify ebtables rules (#555238)

* Tue Jan 19 2010 Chuck Ebbert <cebbert@redhat.com>  2.6.30.10-105.2.2
- Backport fix for CVE-2010-0006:
  kernel: ipv6: skb_dst() can be NULL in ipv6_hop_jumbo() (rhbz#555217)

* Fri Dec 25 2009 Dan Williams <dcbw@redhat.com> 2.6.30.10-105.2.1
