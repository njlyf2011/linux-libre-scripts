...
%define stablelibre -5.15%{?stablegnux}
#define rcrevlibre  -5.15%{?rcrevgnux}
#define gitrevlibre -5.15%{?gitrevgnux}
...
* Fri Jan 14 2022 Alexandre Oliva <lxoliva@fsfla.org> -libre
- GNU Linux-libre 5.15.14-gnu.

* Tue Jan 11 2022 Justin M. Forbes <jforbes@fedoraproject.org> [5.15.14-0]
- Fix up changelog (Justin M. Forbes)

* Fri Jan  7 2022 Alexandre Oliva <lxoliva@fsfla.org> -libre
- GNU Linux-libre 5.15.13-gnu.
